...
function renderQuiz(index) {
    ...
    totalQuestions = p2Count + p3Count + p5Count + p6Count + p7Count;
    ...
    // ----------------------------------------------------
    // 5. PART 7 (Reading Article & Questions)
    // ----------------------------------------------------
...
// Fonction unifiée pour P3, P5, P6 et P7
